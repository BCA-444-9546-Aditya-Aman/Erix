  ...
  <section class="service-hero">
    <div class="service-hero-content">
      <div class="service-hero-eyebrow">
        ...
        <span class="service-hero-eyebrow-text">Who We Are</span>
      </div>
      <h1 class="service-hero-title">About <span>Us</span></h1>
    </div>
  </section>

  <!-- About Section -->
  <section class="about" id="about" style="padding: 80px 5%;">
